...
\begin{figure}[H]
    ...
    \caption{Max Drawdown across Strategies (until 2025)}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{../main/backtest_result/Sharpe_over_time.png}
    \caption{Sharpe Ratio across Strategies (until 2025)}
...
\renewcommand{\refname}{Works Cited} % Renames "References" to "Works Cited"
\begin{thebibliography}{9}

    % Adding standard spacing between entries
    \setlength{\itemsep}{1em} 

    \bibitem{marton2022}
    Marton, Bence, and Hasan Cakir. "Usage of the Hurst Exponent for Short Term Trading Strategies." \textit{SSRN}, 1 Dec. 2022, \url{https://doi.org/10.2139/ssrn.4290787}.
    
    \bibitem{dudia2020}
    Dudia, Ashwin, et al. "Short Term Trading Model for Asian Equity Index Futures -- Using Hurst Exponent." \textit{SSRN}, 23 Feb. 2020, \url{https://doi.org/10.2139/ssrn.3543079}.
